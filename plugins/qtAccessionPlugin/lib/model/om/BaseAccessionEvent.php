...
abstract class BaseAccessionEvent extends QubitObject implements ArrayAccess
{
  const
    ...
    CREATED_AT = 'accession_event.CREATED_AT',
    UPDATED_AT = 'accession_event.UPDATED_AT',
  ...
  public static function addSelectColumns(Criteria $criteria)
  {
    ...
    $criteria->addSelectColumn(QubitAccessionEvent::CREATED_AT);
    $criteria->addSelectColumn(QubitAccessionEvent::UPDATED_AT);
